...
export default function Nav() {
  ...
  // Visiteur OU pendant la résolution : on montre la nav vitrine. Ainsi le bouton
  // "Se connecter" est TOUJOURS visible, même si l'état d'auth met du temps.
  if (auth === "out" || auth === "loading") {
    return (
      <nav className="flex items-center gap-1 text-sm sm:gap-3">
        ...
        <Link href="/auth" className={`font-medium ${link}`}>Se connecter</Link>
